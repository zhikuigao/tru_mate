...
public class Levenshtein {  
    ...
    public static void main(String[] args) {  
        ...
        String str5 = "安全转换问题设置";   
          
        System.out.println(levenshtein(str1, str2));  
        System.out.println(levenshtein(str1, str3));  
        System.out.println(levenshtein(str1, str4));  
        System.out.println(levenshtein(str1, str5));  
        //要比较的两个字符串  
...
//        System.out.printf("i1=%f, i2=%f, i3=%f\n", i1, i2, i3);
    }
