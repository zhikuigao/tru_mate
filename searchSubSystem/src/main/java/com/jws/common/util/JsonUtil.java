...
public class JsonUtil {
    ...
    /***
     * 将对象转换为传入类型的List
     * 此方法在处理时间时存在问题（zhubibo 2016/2/3）
     * @param
     * @param jsonArray
     * @param objectClass
     * @return
...
//		System.out.println(rso);
    	String text = "[{\"userId\":\"12345678901234567890123456789012\",\"keyWord\":\"大数据\",\"createTime\":\"2016-01-28 17:12:11\"},{\"userId\":\"12345678901234567890123456789012\",\"keyWord\":\"大数据\",\"createTime\":\"2016-01-28 17:12:11\"}]";
//    	List<Object> list = toArrayList(text);
//    	for (Object object : list) {
//			System.out.println(object);
//		}
//    	ArrayList<SearchKey> searchKeys = toList(jsonArray, objectClass)
//    	JSONArray jsonArray = JSONArray.fromObject(text);
    	List<SearchKey> searchKeys = toList(text, SearchKey.class);
